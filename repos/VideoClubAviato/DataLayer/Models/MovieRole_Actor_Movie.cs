...
{
    public class MovieRole_Actor_Movie
    {
        //Klasa Movie_Role
        ...
        public MovieRole_Actor_Movie(int id_Role, string role_Name, string role_Description, int id_Actor_Actors, int id_Movie_Movies, int id_Actor, string actor_Name, string actor_Surname, DateTime actor_Date_Of_Birth, bool actor_Oscar, int id_Movie, string movie_Name, int movie_Year, double movie_Duration, bool movie_Oskar, double movie_IMDB_Rating, string movie_Status, int movie_Amount, double movie_Rental_Price, int id_Genre_Genres, int id_Director_Directors)
        {
            Id_Role = id_Role;
            Role_Name = role_Name;
